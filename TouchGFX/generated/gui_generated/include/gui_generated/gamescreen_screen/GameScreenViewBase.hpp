...
protected:
    ...
    touchgfx::TextAreaWithOneWildcard high_score_holder;
    ...
    touchgfx::Image lives_01;
    touchgfx::TextAreaWithOneWildcard lives_board;
    touchgfx::Image wall;

    /*
     * Wildcard Buffers
     */
    static const uint16_t HIGH_SCORE_HOLDER_SIZE = 10;
    touchgfx::Unicode::UnicodeChar high_score_holderBuffer[HIGH_SCORE_HOLDER_SIZE];
    ...
    static const uint16_t LIVES_BOARD_SIZE = 10;
    touchgfx::Unicode::UnicodeChar lives_boardBuffer[LIVES_BOARD_SIZE];
